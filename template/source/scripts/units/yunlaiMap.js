...
define(function (require, exports, module) {
    ...
    require('http://api.map.baidu.com/getscript?v=1.4&ak=A9155741fee0407b4334fcdf906c8d76&services=&t=20150320104737');
    ...
    (function () {
        ...
        YunlaiMap.prototype.addMarker = function (_marker) {
            ...
            marker.addEventListener('click', function (e) {
                ...
                //注册路线绘制按钮点击事件
                if (!window._yunlaiMap_initRouted) {
                    window._yunlaiMap_initRouted = true;
                    $('.BMap_bubble_content').delegate('.navigationButtons a', 'click', function (e) {
                        //获取目标Point和路线类型
                        var toPoint = marker.getPosition();
                        var routeType = $(this).data('route-type');
                        //画路线
